 ...
 */
public class KeywordList extends com.sforce.soap.metadata.Metadata {
    ...
    /**
     * element : keywords of type {http://soap.sforce.com/2006/04/metadata}Keyword
     * java type: com.sforce.soap.metadata.Keyword[]
     */
    private static final com.sforce.ws.bind.TypeInfo keywords__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","keywords","http://soap.sforce.com/2006/04/metadata","Keyword",0,-1,true);

    private boolean keywords__is_set = false;

    private com.sforce.soap.metadata.Keyword[] keywords = new com.sforce.soap.metadata.Keyword[0];

    public com.sforce.soap.metadata.Keyword[] getKeywords() {
      return keywords;
    }

    public void setKeywords(com.sforce.soap.metadata.Keyword[] keywords) {
    ...
    protected void setKeywords(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.isElement(__in, keywords__typeInfo)) {
        setKeywords((com.sforce.soap.metadata.Keyword[])__typeMapper.readObject(__in, keywords__typeInfo, com.sforce.soap.metadata.Keyword[].class));
      }
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "http://soap.sforce.com/2006/04/metadata", "KeywordList");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, keywords__typeInfo, keywords, keywords__is_set);
