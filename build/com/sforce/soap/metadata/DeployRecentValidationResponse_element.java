 ...
 */
public class DeployRecentValidationResponse_element implements com.sforce.ws.bind.XMLizable {

    /**
     * Constructor
     */
    public DeployRecentValidationResponse_element() {}
    ...
    private static final com.sforce.ws.bind.TypeInfo result__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","result","http://www.w3.org/2001/XMLSchema","string",1,1,true);
    ...
    protected void setResult(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, result__typeInfo)) {
        setResult(__typeMapper.readString(__in, result__typeInfo, java.lang.String.class));
      }
    }
    ...
    public String toString() {
      ...
      sb.append("[DeployRecentValidationResponse_element ");
