 ...
 */
public class FlowRecordFilter extends com.sforce.soap.metadata.FlowBaseElement {
    ...
    /**
     * element : operator of type {http://soap.sforce.com/2006/04/metadata}FlowRecordFilterOperator
     * java type: com.sforce.soap.metadata.FlowRecordFilterOperator
     */
    private static final com.sforce.ws.bind.TypeInfo operator__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","operator","http://soap.sforce.com/2006/04/metadata","FlowRecordFilterOperator",1,1,true);

    private boolean operator__is_set = false;

    private com.sforce.soap.metadata.FlowRecordFilterOperator operator;

    public com.sforce.soap.metadata.FlowRecordFilterOperator getOperator() {
      return operator;
    }

    public void setOperator(com.sforce.soap.metadata.FlowRecordFilterOperator operator) {
    ...
    protected void setOperator(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, operator__typeInfo)) {
        setOperator((com.sforce.soap.metadata.FlowRecordFilterOperator)__typeMapper.readObject(__in, operator__typeInfo, com.sforce.soap.metadata.FlowRecordFilterOperator.class));
      }
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "http://soap.sforce.com/2006/04/metadata", "FlowRecordFilter");
