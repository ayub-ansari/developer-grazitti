 ...
 */
public class EventType extends com.sforce.soap.metadata.Metadata {
    ...
    /**
     * element : fields of type {http://soap.sforce.com/2006/04/metadata}EventTypeParameter
     * java type: com.sforce.soap.metadata.EventTypeParameter[]
     */
    private static final com.sforce.ws.bind.TypeInfo fields__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","fields","http://soap.sforce.com/2006/04/metadata","EventTypeParameter",0,-1,true);

    private boolean fields__is_set = false;

    private com.sforce.soap.metadata.EventTypeParameter[] fields = new com.sforce.soap.metadata.EventTypeParameter[0];

    public com.sforce.soap.metadata.EventTypeParameter[] getFields() {
      return fields;
    }

    public void setFields(com.sforce.soap.metadata.EventTypeParameter[] fields) {
      this.fields = fields;
      fields__is_set = true;
    }
    ...
    protected void setFields(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.isElement(__in, fields__typeInfo)) {
        setFields((com.sforce.soap.metadata.EventTypeParameter[])__typeMapper.readObject(__in, fields__typeInfo, com.sforce.soap.metadata.EventTypeParameter[].class));
      }
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "http://soap.sforce.com/2006/04/metadata", "EventType");
