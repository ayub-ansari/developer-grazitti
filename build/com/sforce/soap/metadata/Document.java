...
public class Document extends com.sforce.soap.metadata.MetadataWithContent {
    ...
    /**
     * element : _public of type {http://www.w3.org/2001/XMLSchema}boolean
     * java type: boolean
     */
    private static final com.sforce.ws.bind.TypeInfo _public__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","_public","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
    ...
    protected void set_public(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _public__typeInfo)) {
        set_public(__typeMapper.readBoolean(__in, _public__typeInfo, boolean.class));
      }
    }
