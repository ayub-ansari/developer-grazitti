...
public class ActionOverride implements com.sforce.ws.bind.XMLizable , IActionOverride{
    ...
    private static final com.sforce.ws.bind.TypeInfo formFactor__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","formFactor","http://www.w3.org/2001/XMLSchema","string",1,1,true);
    ...
    protected void setFormFactor(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, formFactor__typeInfo)) {
        setFormFactor(__typeMapper.readString(__in, formFactor__typeInfo, java.lang.String.class));
      }
    }
