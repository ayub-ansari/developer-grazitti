 ...
 */
public class RenderEmailTemplateBodyResult implements com.sforce.ws.bind.XMLizable , IRenderEmailTemplateBodyResult{
    ...
    private static final com.sforce.ws.bind.TypeInfo errors__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","errors","urn:partner.soap.sforce.com","RenderEmailTemplateError",0,-1,true);

    private boolean errors__is_set = false;

    private com.sforce.soap.partner.RenderEmailTemplateError[] errors = new com.sforce.soap.partner.RenderEmailTemplateError[0];
    ...
    public void setErrors(com.sforce.soap.partner.IRenderEmailTemplateError[] errors) {
      this.errors = castArray(com.sforce.soap.partner.RenderEmailTemplateError.class, errors);
      errors__is_set = true;
    }
    ...
    protected void setErrors(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.isElement(__in, errors__typeInfo)) {
        setErrors((com.sforce.soap.partner.RenderEmailTemplateError[])__typeMapper.readObject(__in, errors__typeInfo, com.sforce.soap.partner.RenderEmailTemplateError[].class));
      }
    }
    ...
    private static final com.sforce.ws.bind.TypeInfo mergedBody__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","mergedBody","http://www.w3.org/2001/XMLSchema","string",1,1,true);
    ...
    protected void setMergedBody(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, mergedBody__typeInfo)) {
        setMergedBody(__typeMapper.readString(__in, mergedBody__typeInfo, java.lang.String.class));
      }
    }
    ...
    public String toString() {
      ...
      sb.append(" mergedBody='").append(com.sforce.ws.util.Verbose.toString(mergedBody)).append("'\n");
