...
public class DescribeLayoutSection implements com.sforce.ws.bind.XMLizable , IDescribeLayoutSection{
    ...
    private static final com.sforce.ws.bind.TypeInfo parentLayoutId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","parentLayoutId","urn:partner.soap.sforce.com","ID",1,1,true);
    ...
    protected void setParentLayoutId(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, parentLayoutId__typeInfo)) {
        setParentLayoutId(__typeMapper.readString(__in, parentLayoutId__typeInfo, java.lang.String.class));
      }
    }
    ...
    public String toString() {
      ...
      sb.append(" parentLayoutId='").append(com.sforce.ws.util.Verbose.toString(parentLayoutId)).append("'\n");
