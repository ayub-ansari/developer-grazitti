...
public class RecordTypeInfo implements com.sforce.ws.bind.XMLizable , IRecordTypeInfo{
    ...
    private static final com.sforce.ws.bind.TypeInfo master__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","master","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
    ...
    protected void setMaster(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, master__typeInfo)) {
        setMaster(__typeMapper.readBoolean(__in, master__typeInfo, boolean.class));
      }
    }
    ...
    public String toString() {
      ...
      sb.append(" master='").append(com.sforce.ws.util.Verbose.toString(master)).append("'\n");
