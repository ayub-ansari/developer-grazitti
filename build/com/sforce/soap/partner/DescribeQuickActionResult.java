...
public class DescribeQuickActionResult implements com.sforce.ws.bind.XMLizable , IDescribeQuickActionResult{
    ...
    private static final com.sforce.ws.bind.TypeInfo actionEnumOrId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","actionEnumOrId","http://www.w3.org/2001/XMLSchema","string",1,1,true);
    ...
    protected void setActionEnumOrId(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, actionEnumOrId__typeInfo)) {
        setActionEnumOrId(__typeMapper.readString(__in, actionEnumOrId__typeInfo, java.lang.String.class));
      }
    }
    ...
    private static final com.sforce.ws.bind.TypeInfo showQuickActionVfHeader__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","showQuickActionVfHeader","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
    ...
    protected void setShowQuickActionVfHeader(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, showQuickActionVfHeader__typeInfo)) {
        setShowQuickActionVfHeader(__typeMapper.readBoolean(__in, showQuickActionVfHeader__typeInfo, boolean.class));
      }
    }
    ...
    private static final com.sforce.ws.bind.TypeInfo visualforcePageUrl__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","visualforcePageUrl","http://www.w3.org/2001/XMLSchema","string",1,1,true);
    ...
    protected void setVisualforcePageUrl(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.verifyElement(__in, visualforcePageUrl__typeInfo)) {
        setVisualforcePageUrl(__typeMapper.readString(__in, visualforcePageUrl__typeInfo, java.lang.String.class));
      }
    }
    ...
    public String toString() {
      ...
      sb.append(" actionEnumOrId='").append(com.sforce.ws.util.Verbose.toString(actionEnumOrId)).append("'\n");
      ...
      sb.append(" showQuickActionVfHeader='").append(com.sforce.ws.util.Verbose.toString(showQuickActionVfHeader)).append("'\n");
      ...
      sb.append(" visualforcePageUrl='").append(com.sforce.ws.util.Verbose.toString(visualforcePageUrl)).append("'\n");
