...
public class ExecuteAnonymousResult implements com.sforce.ws.bind.XMLizable {
    ...
    public String toString() {
      ...
      sb.append(" compileProblem='").append(com.sforce.ws.util.Verbose.toString(compileProblem)).append("'\n");
      sb.append(" compiled='").append(com.sforce.ws.util.Verbose.toString(compiled)).append("'\n");
      sb.append(" exceptionMessage='").append(com.sforce.ws.util.Verbose.toString(exceptionMessage)).append("'\n");
      sb.append(" exceptionStackTrace='").append(com.sforce.ws.util.Verbose.toString(exceptionStackTrace)).append("'\n");
